    ...
    <div className="login-page">
      <div className="login-card animate-fade-in">
        <div className="login-header" style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          />
          <h1 className="text-gradient" style={{ fontSize: '24px', fontWeight: '800', lineHeight: '1.2' }}>R&D Deadline Management</h1>
        ...
        <div className="login-footer">
          <p style={{ marginBottom: '8px' }}>© 2026 R&D Deadline Management</p>
        </div>
      </div>
    </div>
  );
